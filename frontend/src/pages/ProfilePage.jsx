          ...
          <div className="space-y-4">
            ...
            <div className="bg-base-100/50 backdrop-blur-md rounded-3xl p-4 border border-base-content/10 flex items-center gap-4 transition-all duration-300 hover:bg-base-100/70">
              ...
              <div className="flex-1">
                <p className="text-xs text-base-content/50 uppercase font-semibold tracking-wider">Full Name</p>
                <p className="text-sm font-medium mt-0.5">{authUser.fullName}</p>
              </div>
            </div>
            ...
            <div className="bg-base-100/50 backdrop-blur-md rounded-3xl p-4 border border-base-content/10 flex items-center gap-4 transition-all duration-300 hover:bg-base-100/70">
              ...
              <div className="flex-1">
                <p className="text-xs text-base-content/50 uppercase font-semibold tracking-wider">Email</p>
